    ...
    public EXAMPLE_FADE() {
        ...
        vlc.add(new JButton(new AbstractAction("Fade 1") {
            ...
            public void actionPerformed(ActionEvent e) {
                NotificationFadeDialogGeneral.builder().header("buajajaja").text("texting texting hua hua hua").color(MaterialColors.PURPLE_400).icon(MaterialIcons.BACKUP).build();
            }
        }));
